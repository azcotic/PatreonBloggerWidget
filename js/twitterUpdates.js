...
/*
  ...
  function handleTweets(tweets) {
    var x = tweets.length;
    var n = 0;
    var element = document.getElementById('clearfixUpdate');
    var html = '';
    //console.log("Cantidad de tweets",x);
    while(n < x) {
      var tweet1= $(tweets[n])[4];
      var imagen =$(tweet1).find("img:first").attr("src");
      var tweet2= $(tweets[n])[1];
      var link = $(tweet2).find("a:first").attr("data-expanded-url");
      var isUp = $(tweet2).find("a:nth-of-type(3)").attr("href");
      //console.log(n);
      //console.log(link);
      //console.log($(tweets[n])[1]);
      //console.log(isUp);
      ...
      n++;
      //  
      } //Es una Actualizacion si tiene el Hashtag #Up de segundo
      else{
        n++;
      }
      //var link = $(tweet1);
      //html += '<li>' + "Hola" + tweets[n] + '</li>';
